...
- YOLOv8 기반의 ONNX<sup id="footnote_1">[1](#footnote_1f)</sup> 모델 활용
- 브라우저 환경에서 실시간으로 Mystical 언어<sup id="footnote_2">[2](#footnote_2f)</sup> 탐지
- 분석된 기호 시퀀스를 PostScript 코드<sup id="footnote_3">[3](#footnote_3f)</sup>로 매핑
- AWS Lambda<sup id="footnote_4">[4](#footnote_4f)</sup> 백엔드에서 해석 및 실행
- AWS cloud front로 배포 진행(https://dcd3zthwdsd4j.cloudfront.net/)

## 주요 기능
- 실시간 기호 탐지: 웹 브라우저 Canvas2D 환경에서 ONNX Runtime<sup id="footnote_5">[5](#footnote_5f)</sup> 기술을 이용하여 사용자 드로잉 실시간 추론
...
<a name="footnote_4f" href="#footnote_4">4</a>: 아마존 웹 서비스(AWS)가 제공하는 이벤트 기반의 서버리스 컴퓨팅 서비스로, 인프라(서버) 관리 없이 코드만 업로드하여 필요할 때마다 실행하는 함수 단위의 연산 플랫폼.

<a name="footnote_5f" href="#footnote_5">5</a>: 크로스 플랫폼 추론 및 학습 머신러닝 가속기